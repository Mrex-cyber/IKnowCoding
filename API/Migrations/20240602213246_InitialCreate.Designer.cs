...
namespace API.Migrations
{
    ...
    [Migration("20240602213246_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Models.Entities.Relationships.UserTeamConnectionEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("rel_users_teams");
                });

            modelBuilder.Entity("DAL.Models.Entities.Tests.AnswerVariantEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DAL.Models.Entities.Tests.QuestionEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DAL.Models.Entities.Tests.TestEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DAL.Models.Entities.User.PersonEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("obj_people");
                });

            modelBuilder.Entity("DAL.Models.Entities.User.TeamAdministrator", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("obj_team_admins");
                });

            modelBuilder.Entity("DAL.Models.Entities.User.TeamEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("IKnowCoding.API.Models.DTO.MainPage.FeedbackEntity", b =>
                {
                    ...
                    b.ToTable("obj_feedbacks");

                    b.HasData(
                        new
                        {
                            Id = 1,
                            Date = new DateTime(2024, 6, 2, 21, 32, 45, 454, DateTimeKind.Utc).AddTicks(2236),
                        ...
                        {
                            Id = 2,
                            Date = new DateTime(2024, 6, 2, 21, 32, 45, 454, DateTimeKind.Utc).AddTicks(2595),
                        ...
                        {
                            Id = 3,
                            Date = new DateTime(2024, 6, 2, 21, 32, 45, 454, DateTimeKind.Utc).AddTicks(2596),
                        ...
                        {
                            Id = 4,
                            Date = new DateTime(2024, 6, 2, 21, 32, 45, 454, DateTimeKind.Utc).AddTicks(2597),
                        ...
                        {
                            Id = 5,
                            Date = new DateTime(2024, 6, 2, 21, 32, 45, 454, DateTimeKind.Utc).AddTicks(2598),
                        ...
                        {
                            Id = 7,
                            Date = new DateTime(2024, 6, 2, 21, 32, 45, 454, DateTimeKind.Utc).AddTicks(2599),
            ...
            modelBuilder.Entity("IKnowCoding.DAL.Models.DTO.Main_Page.AchievementEntity", b =>
                {
                    ...
                    b.ToTable("obj_achievements");

                    b.HasData(
                        new
                        {
                            Id = 1,
                            Date = new DateTime(2024, 6, 2, 21, 32, 45, 454, DateTimeKind.Utc).AddTicks(1218),
                        ...
                        {
                            Id = 2,
                            Date = new DateTime(2024, 6, 2, 21, 32, 45, 454, DateTimeKind.Utc).AddTicks(1521),
            ...
            modelBuilder.Entity("IKnowCoding.DAL.Models.Entities.Relationships.UserTestResultEntity", b =>
                {
                    ...
                    b.ToTable("rel_user_test_results");

                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessTime = new DateTime(2024, 6, 2, 21, 32, 45, 453, DateTimeKind.Utc).AddTicks(9475),
                            Finished = false,
                            FinishedTime = new DateTime(2024, 6, 2, 21, 32, 45, 453, DateTimeKind.Utc).AddTicks(9656),
                            Result = 6,
                            TestId = 1,
                            UserId = 1
                        },
                        ...
                        {
                            Id = 2,
                            AccessTime = new DateTime(2024, 6, 2, 21, 32, 45, 454, DateTimeKind.Utc).AddTicks(189),
                            Finished = false,
                            FinishedTime = new DateTime(2024, 6, 2, 21, 32, 45, 454, DateTimeKind.Utc).AddTicks(189),
                            Result = 4,
                            TestId = 2,
                            UserId = 1
                        },
                        ...
                        {
                            Id = 3,
                            AccessTime = new DateTime(2024, 6, 2, 21, 32, 45, 454, DateTimeKind.Utc).AddTicks(191),
                            Finished = false,
                            FinishedTime = new DateTime(2024, 6, 2, 21, 32, 45, 454, DateTimeKind.Utc).AddTicks(191),
                            Result = 1,
                            TestId = 1,
                            UserId = 2
                        });
            ...
            modelBuilder.Entity("DAL.Models.Entities.Relationships.UserTeamConnectionEntity", b =>
                {
                    b.HasOne("DAL.Models.Entities.User.TeamEntity", "Team")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("DAL.Models.Entities.Tests.AnswerVariantEntity", b =>
                {
                    b.HasOne("DAL.Models.Entities.Tests.QuestionEntity", "Question")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("DAL.Models.Entities.Tests.QuestionEntity", b =>
                {
                    b.HasOne("DAL.Models.Entities.Tests.TestEntity", "Test")
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("DAL.Models.Entities.User.PersonEntity", b =>
                {
                    b.HasOne("DAL.Models.Entities.User.UserEntity", "User")
                        .WithOne("Person")
                        .HasForeignKey("DAL.Models.Entities.User.PersonEntity", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DAL.Models.Entities.User.TeamAdministrator", b =>
                {
                    b.HasOne("DAL.Models.Entities.User.UserEntity", "User")
                        .WithOne()
                        .HasForeignKey("DAL.Models.Entities.User.TeamAdministrator", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DAL.Models.Entities.User.TeamEntity", b =>
                {
                    b.HasOne("DAL.Models.Entities.User.TeamAdministrator", "Admin")
                        .WithMany("Teams")
