    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 5, 29, 8, 58, 3, 60, DateTimeKind.Utc).AddTicks(8127), "https://t3.ftcdn.net/jpg/02/99/04/20/360_F_299042079_vGBD7wIlSeNl7vOevWHiL93G4koMM967.jpg", "Досить корисний та захоплюючий сайт", 1 },
                    { 2, new DateTime(2024, 5, 29, 8, 58, 3, 60, DateTimeKind.Utc).AddTicks(8438), "https://images.unsplash.com/photo-1499952127939-9bbf5af6c51c?q=80&w=2076&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", "Мені подобається випробовувати свої навички", 2 },
                    { 3, new DateTime(2024, 5, 29, 8, 58, 3, 60, DateTimeKind.Utc).AddTicks(8439), "https://st2.depositphotos.com/2931363/6569/i/450/depositphotos_65699901-stock-photo-black-man-keeping-arms-crossed.jpg", "Хотілося б більше тестів", 3 },
                    { 4, new DateTime(2024, 5, 29, 8, 58, 3, 60, DateTimeKind.Utc).AddTicks(8440), "https://images.unsplash.com/photo-1500048993953-d23a436266cf?q=80&w=2069&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", "Покращує вміння мислити нестандартно та оцінити свої знання", 4 },
                    { 5, new DateTime(2024, 5, 29, 8, 58, 3, 60, DateTimeKind.Utc).AddTicks(8440), "https://images.unsplash.com/photo-1504593811423-6dd665756598?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", "Подобається дизайн сайту, допомагає зосередитися", 5 },
                    { 6, new DateTime(2024, 5, 29, 8, 58, 3, 60, DateTimeKind.Utc).AddTicks(8441), "https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", "Можна весело й корисно провести час", 6 },
                    { 7, new DateTime(2024, 5, 29, 8, 58, 3, 60, DateTimeKind.Utc).AddTicks(8442), "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fHBlb3BsZXxlbnwwfHwwfHx8MA%3D%3D", "Гарний дизайн та хороша креативність", 7 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 5, 29, 8, 58, 3, 60, DateTimeKind.Utc).AddTicks(5397), false, new DateTime(2024, 5, 29, 8, 58, 3, 60, DateTimeKind.Utc).AddTicks(5559), 6, 1, 1 },
                    { 2, new DateTime(2024, 5, 29, 8, 58, 3, 60, DateTimeKind.Utc).AddTicks(5996), false, new DateTime(2024, 5, 29, 8, 58, 3, 60, DateTimeKind.Utc).AddTicks(5996), 4, 2, 1 },
                    { 3, new DateTime(2024, 5, 29, 8, 58, 3, 60, DateTimeKind.Utc).AddTicks(5998), false, new DateTime(2024, 5, 29, 8, 58, 3, 60, DateTimeKind.Utc).AddTicks(5998), 1, 1, 2 }
                });
